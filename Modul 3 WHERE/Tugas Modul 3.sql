...
-- Latihan Mandiri 3
-- 1. Hitung selisih tanggal '2022-07-23' dengan tanggal saat ini
SELECT DATEDIFF(NOW(), '2022-07-23') AS selisih_hari;

-- 2. Ekstrak elemen tahun dari tanggal '2022-07-23'
SELECT YEAR('2022-07-23') AS tahun_dari_tanggal;

-- 3. Ekstrak elemen bulan dari tanggal '2022-07-23'
SELECT MONTH('2022-07-23') AS bulan_dari_tanggal;

-- 4. Ekstrak elemen hari dari tanggal '2022-07-23'
SELECT DAY('2022-07-23') AS hari_dari_tanggal;

-- 5. Ekstrak elemen tahun dari tanggal saat ini
SELECT YEAR(NOW()) AS tahun_sekarang;
